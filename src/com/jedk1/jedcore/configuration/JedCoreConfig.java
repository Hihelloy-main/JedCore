...
public class JedCoreConfig {
	...
	private void loadConfigCore() {
		...
		config.addDefault(path + "Damage", 6.0);
		config.addDefault(path + "Range", 12);
		config.addDefault(path + "Hitradius", 3.0);
		config.addDefault(path + "SelfDamage", 2.0);
		config.addDefault(path + "Speed", 1.0);
